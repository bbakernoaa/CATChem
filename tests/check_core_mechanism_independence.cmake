...
set(forbidden_pattern "(O3|NO2|SO2|SO4|DMS|gaschem|carbchem|seasalt|drydep|wetdep|settling)")
foreach(source IN LISTS generic_core_files)
  file(READ "${source}" contents)
  if(contents MATCHES "${forbidden_pattern}")
    message(FATAL_ERROR "Mechanism/process literal '${CMAKE_MATCH_1}' found in generic orchestration file ${source}")
  endif()
endforeach()
