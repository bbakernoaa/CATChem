...
!  I/O routines for CATChem.  FILE\_MOD keeps all of the I/O unit numbers
...
! !USES:
!
!    USE ERROR_MOD, ONLY : GEOS_CHEM_STOP  !LDH: This subroutine de-allocates the array and cleans up after a GEOS-Chem run
!
! !INPUT PARAMETERS:
!
...
110 FORMAT( 'CATCHEM I/O ERROR ', i5, ' in file unit ', i5, /, &
...
120 FORMAT( /, 'Error ', i4, ': ', a )
    ...
    !CALL GEOS_CHEM_STOP  !LDH: Commented this out because we aren't there yet.
