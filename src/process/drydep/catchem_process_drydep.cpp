...
extern "C" {
    void run_drydep_science_bridge(
        ...
        double* bxheight, double* airden, double* t_air, double* pedge, double* rh,
...
void DryDepProcess::run(std::shared_ptr<StateManager> state) {
    ...
    Kokkos::mdspan<double, Kokkos::extents<int, Kokkos::dynamic_extent, 1, 20>, Kokkos::layout_left> frlai(frlai_storage.data(), state->n_cols);
    Kokkos::mdspan<double, Kokkos::extents<int, Kokkos::dynamic_extent, 1, 20>, Kokkos::layout_left> frlanduse(frlanduse_storage.data(), state->n_cols);
    Kokkos::mdspan<int, Kokkos::extents<int, Kokkos::dynamic_extent, 1, 20>, Kokkos::layout_left> iland(iland_storage.data(), state->n_cols);
    ...
    run_drydep_science_bridge(
        ...
        cldfrc.data(), frlai.data_handle(), frlanduse.data_handle(), iland.data_handle(), (bool*)is_ice.data(), (bool*)is_land.data(), (bool*)is_snow.data(),
        ...
        radius.data(), (bool*)is_seasalt.data(), (bool*)is_dust.data(), lower_radius.data(),
        upper_radius.data(), (bool*)is_gas.data(),
