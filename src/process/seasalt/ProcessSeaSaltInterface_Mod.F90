...
!! Generation date: 2025-10-01T13:11:31.049026
...
contains
   ...
   function get_required_met_fields(this) result(field_names)
      ...
      integer :: total_fields, scheme_count, process_count, i
      ...
      ! Combine process-level and scheme-specific fields
      total_fields = process_count + scheme_count
      allocate(field_names(total_fields))

      ! Copy process-level fields first
      do i = 1, process_count
         field_names(i) = process_fields(i)
      end do

      ! Copy scheme-specific fields
      do i = 1, scheme_count
         field_names(process_count + i) = scheme_fields(i)
      end do
