...
**Generated:** 2025-09-12T17:20:30.319072
...
- `AERA_M2` - Meteorological field required for scheme computation
- `SSM` - Meteorological field required for scheme computation
- `T` - Meteorological field required for scheme computation
- `U` - Meteorological field required for scheme computation
- `F_UNDER_PBLTOP` - Meteorological field required for scheme computation
- `PEDGE` - Meteorological field required for scheme computation
- `PEDGE_DRY` - Meteorological field required for scheme computation
...
pure subroutine compute_geos12( &
   num_layers, num_species, params, &
   FROCEAN, &   FRSEAICE, &   SST, &   USTAR, &   AERA_M2, &   SSM, &   T, &   U, &   F_UNDER_PBLTOP, &   PEDGE, &   PEDGE_DRY, &
   species_conc, emission_flux)
```
...
---
*This documentation was automatically generated by the CATChem Process Generator on 2025-09-12T17:20:30.319072*